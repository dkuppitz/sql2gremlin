...
* http://tinkerpop.apache.org/docs/current/reference/#has-step[Has Step]
* http://tinkerpop.apache.org/docs/current/reference/#valuemap-step[ValueMap Step]
...
* http://tinkerpop.apache.org/docs/current/reference/#has-step[Has Step]
* http://tinkerpop.apache.org/docs/current/reference/#lambda-steps[Lambda Steps]
...
* http://tinkerpop.apache.org/docs/current/reference/#dedup-step[Dedup Step]
* http://tinkerpop.apache.org/docs/current/reference/#has-step[Has Step]
* http://tinkerpop.apache.org/docs/current/reference/#lambda-steps[Lambda Steps]
* http://docs.oracle.com/javase/8/docs/api/java/lang/String.html#length--[String::length()]
...
* http://tinkerpop.apache.org/docs/current/reference/#has-step[Has Step]
* http://tinkerpop.apache.org/docs/current/reference/#lambda-steps[Lambda Steps]
* http://tinkerpop.apache.org/docs/current/reference/#max-step[Max Step]
* http://docs.oracle.com/javase/8/docs/api/java/lang/String.html#length--[String::length()]
...
* http://tinkerpop.apache.org/docs/current/reference/#has-step[Has Step]
* http://tinkerpop.apache.org/docs/current/reference/#valuemap-step[ValueMap Step]
* http://tinkerpop.apache.org/docs/current/reference/#a-note-on-predicates[A Note on Predicates]
...
* http://tinkerpop.apache.org/docs/current/reference/#has-step[Has Step]
* http://tinkerpop.apache.org/docs/current/reference/#order-step[Order Step]
* http://tinkerpop.apache.org/docs/current/reference/#valuemap-step[ValueMap Step]
...
* http://tinkerpop.apache.org/docs/current/reference/#has-step[Has Step]
* http://tinkerpop.apache.org/docs/current/reference/#limit-step[Limit Step]
* http://tinkerpop.apache.org/docs/current/reference/#order-step[Order Step]
* http://tinkerpop.apache.org/docs/current/reference/#valuemap-step[ValueMap Step]
...
* http://tinkerpop.apache.org/docs/current/reference/#has-step[Has Step]
* http://tinkerpop.apache.org/docs/current/reference/#range-step[Range Step]
* http://tinkerpop.apache.org/docs/current/reference/#order-step[Order Step]
* http://tinkerpop.apache.org/docs/current/reference/#valuemap-step[ValueMap Step]
...
g.V().hasLabel("product").groupCount().by("unitPrice").
      order(local).by(values, decr).select(keys).limit(1)
----

*References:*

* http://tinkerpop.apache.org/docs/current/reference/#has-step[Has Step]
* http://tinkerpop.apache.org/docs/current/reference/#groupcount-step[GroupCount Step]
* http://tinkerpop.apache.org/docs/current/reference/#limit-step[Limit Step]
* http://tinkerpop.apache.org/docs/current/reference/#order-step[Order Step]
* http://tinkerpop.apache.org/docs/current/reference/#select-step[Select Step]
* http://tinkerpop.apache.org/docs/current/reference/#valuemap-step[ValueMap Step]
...
* http://tinkerpop.apache.org/docs/current/reference/#has-step[Has Step]
* http://tinkerpop.apache.org/docs/current/reference/#vertex-steps[Vertex Steps]
...
* http://tinkerpop.apache.org/docs/current/reference/#as-step[As Step]
* http://tinkerpop.apache.org/docs/current/reference/#count-step[Count Step]
* http://tinkerpop.apache.org/docs/current/reference/#has-step[Has Step]
* http://tinkerpop.apache.org/docs/current/reference/#match-step[Match Step]
* http://tinkerpop.apache.org/docs/current/reference/#select-step[Select Step]
* http://tinkerpop.apache.org/docs/current/reference/#vertex-steps[Vertex Steps]
...
* http://tinkerpop.apache.org/docs/current/reference/#has-step[Has Step]
* http://tinkerpop.apache.org/docs/current/reference/#lambda-steps[Lambda Steps]
* http://tinkerpop.apache.org/docs/current/reference/#union-step[Union Step]
...
* http://tinkerpop.apache.org/docs/current/reference/#_mutating_the_graph[Mutating the Graph]
* http://tinkerpop.apache.org/docs/current/reference/#has-step[Has Step]
* http://tinkerpop.apache.org/docs/current/reference/#drop-step[Drop Step]
...
* http://tinkerpop.apache.org/docs/current/reference/#has-step[Has Step]
* http://tinkerpop.apache.org/docs/current/reference/#lambda-steps[Lambda Steps]
* http://tinkerpop.apache.org/docs/current/reference/#repeat-step[Repeat Step]
* http://tinkerpop.apache.org/docs/current/reference/#select-step[Select Step]
* http://tinkerpop.apache.org/docs/current/reference/#vertex-steps[Vertex Steps]
* http://tinkerpop.apache.org/docs/current/reference/#tree-step[Tree Step]
* http://tinkerpop.apache.org/docs/current/reference/#where-step[Where Step]
...
* http://tinkerpop.apache.org/docs/current/reference/#as-step[As Step]
* http://tinkerpop.apache.org/docs/current/reference/#group-step[Group Step]
* http://tinkerpop.apache.org/docs/current/reference/#has-step[Has Step]
* http://tinkerpop.apache.org/docs/current/reference/#order-step[Order Step]
* http://tinkerpop.apache.org/docs/current/reference/#select-step[Select Step]
* http://tinkerpop.apache.org/docs/current/reference/#sum-step[Sum Step]
* http://tinkerpop.apache.org/docs/current/reference/#where-step[Where Step]
* http://tinkerpop.apache.org/docs/current/reference/#vertex-steps[Vertex Steps]
...
g.V().has("customerId", "ALFKI").as("customer").
      ...
      groupCount().order(local).by(values, decr).select(keys).limit(5).
      values("name")
----

*References:*

* http://tinkerpop.apache.org/docs/current/reference/#aggregate-step[Aggregate Step]
* http://tinkerpop.apache.org/docs/current/reference/#as-step[As Step]
* http://tinkerpop.apache.org/docs/current/reference/#groupcount-step[GroupCount Step]
* http://tinkerpop.apache.org/docs/current/reference/#has-step[Has Step]
* http://tinkerpop.apache.org/docs/current/reference/#limit-step[Limit Step]
